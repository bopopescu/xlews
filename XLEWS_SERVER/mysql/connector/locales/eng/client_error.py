...
_GENERATED_ON = '2012-07-04'
_MYSQL_VERSION = (5, 6, 5)

# Start MySQL Error messages
CR_UNKNOWN_ERROR = "Unknown MySQL error"
CR_SOCKET_CREATE_ERROR = "Can't create UNIX socket (%d)"
CR_CONNECTION_ERROR = "Can't connect to local MySQL server through socket '%-.100s' (%d)"
CR_CONN_HOST_ERROR = "Can't connect to MySQL server on '%-.100s' (%d)"
CR_IPSOCK_ERROR = "Can't create TCP/IP socket (%d)"
CR_UNKNOWN_HOST = "Unknown MySQL server host '%-.100s' (%d)"
...
CR_NAMEDPIPEWAIT_ERROR = "Can't wait for named pipe to host: %-.64s  pipe: %-.32s (%lu)"
CR_NAMEDPIPEOPEN_ERROR = "Can't open named pipe to host: %-.64s  pipe: %-.32s (%lu)"
CR_NAMEDPIPESETSTATE_ERROR = "Can't set state of named pipe to host: %-.64s  pipe: %-.32s (%lu)"
...
CR_SERVER_LOST_EXTENDED = "Lost connection to MySQL server at '%s', system error: %d"
